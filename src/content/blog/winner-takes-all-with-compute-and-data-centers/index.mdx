...
Then I remember it well: machine learning, then deep learning, neural networks, then generative AI, then [ChatGPT](https://chatgpt.com), then agents, then [Claude Code](https://www.anthropic.com/claude-code). And now the situation is very different.
