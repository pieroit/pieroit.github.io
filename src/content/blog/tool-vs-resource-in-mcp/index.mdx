...
Prompts are simply a collection of prompts. Tools get chosen by the language model. Prompts you typically put in front of the end user of the application, to offer them ready-made prompts they can fire off. The famous prompt libraries, and [Claude](https://claude.ai)'s latest skills feature, are based on MCP prompts, I believe.
...
I can't wait to show you. Right now there's a whole piece that's broken, it needs fixing, but it already works, and I'll update you soon. I'll come back at it, grab a few stars on [GitHub](https://github.com). If you want to contribute, to test it, I'll make some tutorial videos too. Let's also see if the core contributors are up for this next journey.
