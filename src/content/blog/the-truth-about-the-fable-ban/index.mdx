...
So what's the truth? Why did the US government block [Anthropic](https://www.anthropic.com)'s Fable and Mythos models? What's going on behind this whole soap opera?
...
In fact, the latest blog post that [Dario] [Amodei](https://en.wikipedia.org/wiki/Dario_Amodei) wrote says exactly this: we need a certification process for models, similar to the one used for airplanes.
