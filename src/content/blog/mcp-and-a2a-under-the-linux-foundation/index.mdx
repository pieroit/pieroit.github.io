...
For this reason, protocols are really important. I'm happy to read that [Anthropic](https://www.anthropic.com) decided to donate the [Model Context Protocol](https://modelcontextprotocol.io) to the [Linux Foundation](https://www.linuxfoundation.org), and a few months ago Google also donated the [A2A](https://a2a-protocol.org) protocol to the Linux Foundation. So maybe in 2026 we'll see the protocols officially unified. I hope so. Let's talk about the differences between these two protocols.
