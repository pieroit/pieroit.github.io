...
Then there are connectors, which are [MCP](https://modelcontextprotocol.io) servers. Here I added a local MCP [GitHub](https://github.com). Let me show you another context. In this one, for example, I have GitHub and I have a local MCP server that works on a folder on my system, so I can produce files, work on them, and then send them around using the agents.
